        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            >
                <div className="flex items-center justify-between p-6 border-b border-border">
                    <h3 className="text-xl font-bold">Add to Google Calendar</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto max-h-[70vh]">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        />
                        <label htmlFor="allDay" className="text-sm font-medium cursor-pointer">All Day Event</label>
                    </div>
                    ...
                    <div className="pt-4 flex gap-3 justify-end">
                        ...
                        >
                            {isSubmitting ? (
                                ...
                                <>
                                    <img src="/icons/google-calendar.png" alt="" className="h-4 w-4 object-contain brightness-0 invert" />
