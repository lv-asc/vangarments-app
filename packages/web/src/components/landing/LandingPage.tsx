                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="text-center md:text-left max-w-3xl">
                            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
                                Welcome to <span className="text-secondary">Vangarments</span>
                            </h1>
                            <p className="text-xl md:text-2xl text-muted-foreground font-light leading-relaxed">
                                Your digital fashion hub. Organize, create and get inspired.
                            </p>
                        </motion.div>
                        ...
                        <div className="mt-16">
                            <motion.div variants={itemVariants} className="mb-8">
                                ...
                                <p className="text-muted-foreground">Select how you want to interact with Vangarments today.</p>
                            </motion.div>
