...
const tiers = [
  {
    ...
    href: '/register',
    priceMonthly: '$0',
    description: 'Perfect to start organizing your wardrobe.',
    features: [
      'Up to 50 cataloged items',
      'Manual cataloging',
      'Basic profile',
      'View public looks',
      'Email support',
  ...
  },
  {
    ...
    priceMonthly: '$4.99',
    description: 'For those who want to take full advantage of the platform.',
    features: [
      'Unlimited items',
      'AI-powered automatic cataloging',
  ...
  },
  {
    ...
    priceMonthly: '$9.99',
    description: 'For content creators and fashion professionals.',
    features: [
    ...
    <div id="pricing" className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-base font-semibold leading-7 text-[#00132d]">Pricing</h2>
          <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Choose the ideal plan for you
          </p>
        </div>
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
          Start for free and scale as needed.
          All plans include access to our fashion community.
        </p>
        ...
        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 xl:gap-x-12">
          {tiers.map((tier, index) => (
            ...
            >
              ...
              >
                {tier.name === 'Free' ? 'Start for free' : 'Subscribe'}
              </Link>
