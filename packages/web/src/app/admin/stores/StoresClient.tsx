...
export default function AdminStoresPage() {
    ...
    const fetchStores = async () => {
        try {
            setLoading(true);
            // Fetch stores specifically
            const response = await brandApi.getBrands({ limit: 1000, businessType: 'store' });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-24">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-600">Manage store profiles and details. {processedBrands.length} stores found.</p>
                </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="truncate">
                                            <div className="flex text-sm items-center gap-2">
                                                <p className="font-medium text-blue-600 truncate">{brand.brandInfo?.name || 'Unnamed Store'}</p>
            ...
            <BulkActionsBar
                ...
                onSuccess={() => { clearSelection(); fetchStores(); }}
            />
        </div>
    );
}
